...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=sqlserver;Database=persona_db;TrustServerCertificate=true;User Id=sa;Password=Arqui1234");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Estudio>(entity =>
        {
            entity.HasKey(e => new { e.IdProf, e.CcPer }).HasName("PK__ESTUDIOS__FB3F71A6D065916B");
        ...
        {
            entity.HasKey(e => e.Cc).HasName("PK__PERSONA__3213666DE792DC20");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PROFESIO__3213E83FE9A228CB");
        ...
        {
            entity.HasKey(e => e.Num).HasName("PK__TELEFONO__DF908D658198F98C");
